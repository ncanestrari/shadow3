...
if __name__ == '__main__':
  ...
  helps = {
    ...
    'c':'set simulation for canted undulator, values means distance between straight section and center of undulator. [m]',
  ...
  #else:
  #  lim=None
  beam,param = sd.ShadowSrw.genShadowBeam(options.infile,options.rays,options.method,energy=options.energy,lim=lim,canted=options.canted)
