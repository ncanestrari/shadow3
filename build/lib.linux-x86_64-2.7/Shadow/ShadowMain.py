...
#  def srwSource(self,fnameHdf5,N=100000,output="begin.dat",out_param="begin.py",write=False):
#    self, dic = genShadowBeam(fnameHdf5,N=N)
#    
#    if write:
#      sys.stdout.write("saving Beam to " + output + " ")
#      sys.stdout.flush()
#      beam.write(output) 
#      sys.stdout.write("done\n")
#
#      sys.stdout.write("saving parameters for plots to " + out_param + " ")
#      sys.stdout.flush()
#      WriteParameters(out_param,dic)
#      sys.stdout.write("done\n")
#    return dic
